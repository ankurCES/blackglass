//! blackglass-mcp-flipper — Flipper Zero MCP server.
//!
//! Exposes 4 tools (list, read, write, run) over JSON-RPC-over-stdio.
//! All hardware interaction goes through the Python bridge (pyflipper).
...
#[derive(Parser)]
#[command(name = "blackglass-mcp-flipper", version)]
struct Cli {
